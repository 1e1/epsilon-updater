...
- Mode **démo/virtuel** par défaut (aucun USB réel). `NWUPDATER_REAL=1` pour piloter une
  vraie calculatrice (nécessite `pyusb`/libusb) ; repli automatique sur la démo si absent.
